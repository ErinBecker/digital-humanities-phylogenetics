...
# read in section definitions
sections_file = "data/sections/Q39_sections.csv"
...
# so we will use the Q39_doc_sections object to get the names of the 
# documents to include
doc_names = names(Q39_doc_sections[which(Q39_num_sections >= 8)])

for(i in 1:1000) {
  corpus_file = paste0("data/pass/bootstrap/Q39_par_bootstrap/Q39_par_bootstrap_", i, ".csv")
  dist_file = paste0("data/section_SI/bootstrap/distance_matrices/Q39_par_dist_matrix_", i, ".csv")
...
for(i in 1:1000) {
  filename_in = paste0("data/section_SI/bootstrap/distance_matrices/Q39_par_dist_matrix_", i, ".csv")
  filename_out = paste0("data/section_SI/bootstrap/trees/sect_si_nj_", i, ".tre")
...
for(i in 1:1000) {
  filename_in = paste0("data/section_SI/bootstrap/trees/sect_si_nj_", i, ".tre")
  name = paste0("tree_", i)
...
write.tree(consensus_50, "data/section_SI/bootstrap/consensus_trees/consensus_50.tre")

consensus_75 = consensus(trees, p = 0.75)
write.tree(consensus_75, "data/section_SI/bootstrap/consensus_trees/consensus_75.tre")
```
...
write.tree(avg_tree, "data/section_SI/bootstrap/consensus_trees/avg_tree.tre")
mcc_tree = maxCladeCred(trees)
write.tree(mcc_tree, "data/section_SI/bootstrap/consensus_trees/mcc_tree.tre")

pdf("data/section_SI/bootstrap/consensus_trees/mcc_tree.pdf")
ggtree(mcc_tree) + geom_tiplab()
dev.off()

pdf("data/section_SI/bootstrap/consensus_trees/avg_tree.pdf")
