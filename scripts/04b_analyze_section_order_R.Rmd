...
Let's junk the X. sections (in the previous script). 

```{r echo = FALSE, eval = FALSE}
unique(corpus[grep("X\\.4", corpus$section),])
```
...
Note that the theoretical maximum SI for a document pair depends on k, but is
always less than 2k, because sections at the end and beginning of documents can
never have a SI of 2k, even if they match perfectly with the comparison document. 
